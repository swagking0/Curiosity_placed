...
parser.add_argument('-w', '--num-workers', default=01, type=int,
...
parser.add_argument('--unsup', type=str, default='state',
...
parser.add_argument('--pretrain', type=str, default="/home/swagking0/noreward-rl/src/tmp/doom/train/checkpoint", help="Checkpoint dir (generally ..../train/) to load from.")
