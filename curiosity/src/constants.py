...
'MAX_GLOBAL_STEPS': 50000,  # total steps taken across all workers
'LEARNING_RATE': 1e-4,  # learning rate for adam

'PREDICTION_BETA': 0.5,  # weight of prediction bonus
                          # set 0.5 for unsup=state
'PREDICTION_LR_SCALE': 40.0,  # scale lr of predictor wrt to policy network
